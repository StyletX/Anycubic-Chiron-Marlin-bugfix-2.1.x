...
#define STRING_CONFIG_H_AUTHOR "(StyletX, Chiron Build)" // Who made the changes.
...
#define PIDTEMP 1        // See the PID Tuning Guide at https://reprap.org/wiki/PID_Tuning
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Chiron
  #define DEFAULT_bedKp  41.32
  #define DEFAULT_bedKi  7.53
  #define DEFAULT_bedKd 151.20
...
#if EITHER(AUTO_BED_LEVELING_DISTINCT_E_FACTORS, AUTO_BED_LEVELING_BILINEAR)
