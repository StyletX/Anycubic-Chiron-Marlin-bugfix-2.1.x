...
#define MSG_MY_VERSION "V2.1.3"
#define STRING_CONFIG_H_AUTHOR "(AKIRA)" // Who made the changes.
...
#define STRING_CONFIG_H_AUTHOR "(AKIRA, Chiron Build)" // Who made the changes.
 ...
 */
#define X_DRIVER_TYPE  TMC2208_STANDALONE  // UPDATED
#define Y_DRIVER_TYPE  TMC2209_STANDALONE  // UPDATED
#define Z_DRIVER_TYPE  TMC2208_STANDALONE  // UPDATED
//#define X2_DRIVER_TYPE A4988
//#define Y2_DRIVER_TYPE A4988
#define Z2_DRIVER_TYPE TMC2208_STANDALONE  // UPDATED
...
#define E0_DRIVER_TYPE TMC2100  // UPDATED
#define E1_DRIVER_TYPE TMC2208_STANDALONE  // UPDATED
...
//#define MPCTEMP            // UPDATED // ** EXPERIMENTAL **
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // Chiron  // UPDATED
   #define DEFAULT_Kp 7.71
   #define DEFAULT_Ki 0.28
   #define DEFAULT_Kd 52.40
  #endif
#endif
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 11.63f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.0737f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Chiron  // UPDATED
  #define DEFAULT_bedKp 64.56
  #define DEFAULT_bedKi 12.12
  #define DEFAULT_bedKd 229.19
...
#define ENDSTOPPULLUPS
  ...
  #define ENDSTOPPULLUP_XMIN  // UPDATED
  #define ENDSTOPPULLUP_YMIN  // UPDATED
  #define ENDSTOPPULLUP_ZMIN  // UPDATED
 ...
 */
#define X_MIN_ENDSTOP_HIT_STATE LOW  // UPDATED
#define X_MAX_ENDSTOP_HIT_STATE LOW  // UPDATED
#define Y_MIN_ENDSTOP_HIT_STATE LOW  // UPDATED
#define Y_MAX_ENDSTOP_HIT_STATE LOW  // UPDATED
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79, 97, 400, 115 }  // UPDATED
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 25, 80 }  // UPDATED
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 100, 3000 }  // UPDATED
 ...
 */
#define DEFAULT_ACCELERATION           800    // UPDATED // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  1000    // UPDATED // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   1500    // UPDATED // X, Y, Z acceleration for travel (non printing) moves
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  // UPDATED
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -35, -6, -3.05 }  // UPDATED
...
// Invert the stepper direction. Change (or reverse the motor connector) if an axis goes the wrong way. // UPDATED
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE +10  // UPDATED
#define Y_MAX_POS Y_BED_SIZE +10  // UPDATED
#define Z_MAX_POS 455  // UPDATED
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define AUTO_BED_LEVELING_BILINEAR  //UPDATED
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 5  // UPDATED
 ...
 */
#define EEPROM_SETTINGS       // UPDATE // Persistent storage with M500 and M501
//#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release!
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save PROGMEM.
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  //#define EEPROM_AUTO_INIT  // Init EEPROM automatically on any errors.
  #define EEPROM_INIT_NOW     // UPTADE // Init EEPROM on first boot after a new build.
#endif
...
//
#define PREHEAT_1_LABEL       "PETG"  // UPDATED
#define PREHEAT_1_TEMP_HOTEND 225
#define PREHEAT_1_TEMP_BED     70
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "PLA"  // UPDATED
 ...
 */
#define SD_CHECK_AND_RETRY  // UPDATED
...
//
//#define REVERSE_MENU_DIRECTION  // UPDATED
...
//
//#define REVERSE_SELECT_DIRECTION  // UPDATED
