 ...
 */
  ...
  #define THERMAL_PROTECTION_HYSTERESIS 6     // UPDATED // Degrees Celsius
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  60               // UPDATED // Seconds
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        60 // UPDATED // Seconds
 ...
 */
#define E0_AUTO_FAN_PIN  44  // UPDATED
...
#define QUICK_HOME                            // UPDATED // If G28 contains XY do a diagonal move first
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  //#define STATUS_MESSAGE_SCROLLING  // UPDATED
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY  // UPDATED
  #if ENABLED(POWER_LOSS_RECOVERY)
    #define PLR_ENABLED_DEFAULT   true  // Power Loss Recovery enabled by default. (Set with 'M413 Sn' & M500)
    //#define BACKUP_POWER_SUPPLY       // Backup power / UPS to move the steppers on power loss
    //#define POWER_LOSS_ZRAISE       2 // (mm) Z axis raise on resume (on power loss with UPS)
    #define POWER_LOSS_PIN         OUTAGETEST_PIN    // UPDATED // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
    #define POWER_LOSS_STATE      LOW   // UPDATED // State of pin indicating power loss
    #define POWER_LOSS_PULLUP           // UPDATED // Set pullup / pulldown as appropriate for your sensor
    //#define POWER_LOSS_PULLDOWN
    #define POWER_LOSS_PURGE_LEN    5   // UPDATED // (mm) Length of filament to purge on resume
  ...
  //#define UTF_FILENAME_SUPPORT  // UPDATE

  //#define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  //#define SCROLL_LONG_FILENAMES           // UPDATED // Scroll long filenames in the SD card menu
...
// G2/G3 Arc Support
//
#define ARC_SUPPORT                 // UPDATE // Requires ~3226 bytes
 ...
 */
#define EMERGENCY_PARSER  // UPDATE
 ...
 */
#define ADVANCED_PAUSE_FEATURE  // UPDATED
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         60  // (mm/s) Initial retract feedrate.
  #define PAUSE_PARK_RETRACT_LENGTH            4  // UPDATED // (mm) Initial retract.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    20  // UPDATED // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define FILAMENT_UNLOAD_PURGE_LENGTH         0  // UPDATED // (mm) An unretract is done, then this length is purged.
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE      25  // (mm/s) feedrate to purge before unload

  #define PAUSE_PARK_NOZZLE_TIMEOUT           45  // (seconds) Time limit before the nozzle is turned off for safety.
  #define FILAMENT_CHANGE_ALERT_BEEPS          6  // UPDATED // Number of alert beeps to play when a response is needed.
...
#define M114_DETAIL           // UPDATED // Use 'M114` for details to check planner calculations
